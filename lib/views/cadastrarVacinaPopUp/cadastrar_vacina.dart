                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: ElevatedButton(
                          onPressed: () {
                            String cadastroBuffer;
                            try {
                              cadastroBuffer = provider.cadastrarVacina();
                            } catch (e) {
                              cadastroBuffer = "Erro: Preencha todos os campos.";
                            }
                            dialogConfirm(context, cadastroBuffer);
                          },
                          style: ElevatedButton.styleFrom(
                            backgroundColor: AppColors.vacinaPrimaryAddColor,
