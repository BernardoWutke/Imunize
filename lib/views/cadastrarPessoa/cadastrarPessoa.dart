          ...
          builder: (context, provider , child) =>  Column(
            children: [
              Container(
                ...
                child: Text("  Cadastrar Pessoa", style: AppFonts.titleBar,),
              ),
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Text("Sexo:", style: AppFonts.titleButtonBlack,),
                    ...
                    DropdownButton<String>(
                      ...
                      items: <String>['Masculino', 'Feminino']
                        ...
                        return DropdownMenuItem<String>(
                          value: value,
                          child: Text(value, style: AppFonts.titleButtonBlack,),
                        );
                      }).toList(),
                  ),
                  ],
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Text("Estado Civil:", style: AppFonts.titleButtonBlack,),
                    SizedBox(width: size.width * 0.01,),
                    DropdownButton<String>(
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Text("Escolaridade:", style: AppFonts.titleButtonBlack,),
                    SizedBox(width: size.width * 0.01,),
                    DropdownButton<String>(
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Text("Cor:", style: AppFonts.titleButtonBlack,),
                    SizedBox(width: size.width * 0.01,),
                    DropdownButton<String>(
                      value: provider.cor,
                      icon: const Icon(Icons.arrow_downward),
